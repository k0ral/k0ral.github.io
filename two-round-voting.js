...
(function($PS) {
  ...
  var showChoice = new Data_Show.Show(function (v) {
      if (v instanceof AltA) {
          return "A";
      };
      if (v instanceof AltB) {
          return "B";
      };
      if (v instanceof AltC) {
          return "C";
      };
      throw new Error("Failed pattern match at Choice (line 22, column 1 - line 25, column 18): " + [ v.constructor.name ]);
  });
  var eqChoice = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof AltA && y instanceof AltA) {
              return true;
          };
          if (x instanceof AltB && y instanceof AltB) {
              return true;
          };
          if (x instanceof AltC && y instanceof AltC) {
              return true;
          };
          return false;
      };
  });
  var ordChoice = new Data_Ord.Ord(function () {
      return eqChoice;
  }, function (x) {
      return function (y) {
          if (x instanceof AltA && y instanceof AltA) {
          ...
          if (x instanceof AltA) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof AltA) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof AltB && y instanceof AltB) {
              return Data_Ordering.EQ.value;
          };
          if (x instanceof AltB) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof AltB) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof AltC && y instanceof AltC) {
              return Data_Ordering.EQ.value;
          };
          throw new Error("Failed pattern match at Choice (line 29, column 1 - line 29, column 40): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var boundedChoice = new Data_Bounded.Bounded(function () {
      return ordChoice;
  }, AltA.value, AltC.value);
  var boundedEnumChoice = new Data_Enum.BoundedEnum(function () {
      return boundedChoice;
  }, function () {
      return enumChoice;
  }, 3, function (v) {
      if (v instanceof AltA) {
      ...
      throw new Error("Failed pattern match at Choice (line 35, column 1 - line 43, column 20): " + [ v.constructor.name ]);
  }, function (v) {
      if (v === 0) {
          return new Data_Maybe.Just(AltA.value);
      };
      if (v === 1) {
          return new Data_Maybe.Just(AltB.value);
      };
      if (v === 2) {
          return new Data_Maybe.Just(AltC.value);
      };
      return Data_Maybe.Nothing.value;
  });
  var enumChoice = new Data_Enum.Enum(function () {
      return ordChoice;
  }, Data_Enum.defaultPred(Data_Enum.toEnum(boundedEnumChoice))(Data_Enum.fromEnum(boundedEnumChoice)), Data_Enum.defaultSucc(Data_Enum.toEnum(boundedEnumChoice))(Data_Enum.fromEnum(boundedEnumChoice)));
  var all_choices = Data_Enum.enumFromTo(enumChoice)(Data_Unfoldable1.unfoldable1Array)(Data_Bounded.bottom(boundedChoice))(Data_Bounded.top(boundedChoice));
  exports["AltA"] = AltA;
  exports["AltB"] = AltB;
  exports["AltC"] = AltC;
  exports["all_choices"] = all_choices;
  exports["showChoice"] = showChoice;
  exports["eqChoice"] = eqChoice;
  exports["ordChoice"] = ordChoice;
  exports["boundedEnumChoice"] = boundedEnumChoice;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
...
(function($PS) {
  ...
  var values_set = function (dictBoundedEnum) {
      return Data_Set.fromFoldable(Data_List_Types.foldableList)((dictBoundedEnum.Enum1()).Ord0())(Data_Enum.upFromIncluding(dictBoundedEnum.Enum1())(Data_List_Types.unfoldable1List)(Data_Bounded.bottom(dictBoundedEnum.Bounded0())));
  };
  var all_permutations_set = function (dictOrd) {
      return function (set) {
          var v = Data_Set.toUnfoldable(Data_List_Types.unfoldableList)(set);
          if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Nil) {
              return new Data_List_Types.Cons(new Data_List_Types.Cons(v.value0, Data_List_Types.Nil.value), Data_List_Types.Nil.value);
          };
          return Data_List.concatMap(function (value) {
              return Data_Functor.map(Data_List_Types.functorList)(Data_List_Types.Cons.create(value))(all_permutations_set(dictOrd)(Data_Set["delete"](dictOrd)(value)(set)));
          })(v);
      };
  };
  var all_permutations = function (dictBoundedEnum) {
      return all_permutations_set((dictBoundedEnum.Enum1()).Ord0())(values_set(dictBoundedEnum));
  };
...
(function($PS) {
  ...
  var exports = $PS["Parameter"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Map_Internal = $PS["Data.Map.Internal"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Ord = $PS["Data.Ord"];
  var Data_Ordering = $PS["Data.Ordering"];                
  var AthenBwhenCworst = (function () {
      function AthenBwhenCworst() {

      };
      AthenBwhenCworst.value = new AthenBwhenCworst();
      return AthenBwhenCworst;
  })();
  var AthenCwhenBworst = (function () {
      function AthenCwhenBworst() {

      };
      AthenCwhenBworst.value = new AthenCwhenBworst();
      return AthenCwhenBworst;
  })();
  var BthenCwhenAworst = (function () {
      function BthenCwhenAworst() {

      };
      BthenCwhenAworst.value = new BthenCwhenAworst();
      return BthenCwhenAworst;
  })();
  var Aworst = (function () {
      function Aworst() {

      };
      Aworst.value = new Aworst();
      return Aworst;
  })();
  var Bworst = (function () {
      function Bworst() {
      ...
      Bworst.value = new Bworst();
      return Bworst;
  })();
  var eqParameter = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof AthenBwhenCworst && y instanceof AthenBwhenCworst) {
              return true;
          };
          if (x instanceof AthenCwhenBworst && y instanceof AthenCwhenBworst) {
              return true;
          };
          if (x instanceof BthenCwhenAworst && y instanceof BthenCwhenAworst) {
              return true;
          };
          if (x instanceof Aworst && y instanceof Aworst) {
              return true;
          };
          if (x instanceof Bworst && y instanceof Bworst) {
              return true;
          };
          return false;
      };
  });
  var ordParameter = new Data_Ord.Ord(function () {
      return eqParameter;
  }, function (x) {
      return function (y) {
          if (x instanceof AthenBwhenCworst && y instanceof AthenBwhenCworst) {
          ...
          if (x instanceof AthenBwhenCworst) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof AthenBwhenCworst) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof AthenCwhenBworst && y instanceof AthenCwhenBworst) {
              return Data_Ordering.EQ.value;
          };
          if (x instanceof AthenCwhenBworst) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof AthenCwhenBworst) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof BthenCwhenAworst && y instanceof BthenCwhenAworst) {
              return Data_Ordering.EQ.value;
          };
          if (x instanceof BthenCwhenAworst) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof BthenCwhenAworst) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof Aworst && y instanceof Aworst) {
              return Data_Ordering.EQ.value;
          };
          if (x instanceof Aworst) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof Aworst) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof Bworst && y instanceof Bworst) {
              return Data_Ordering.EQ.value;
          };
          throw new Error("Failed pattern match at Parameter (line 17, column 1 - line 17, column 46): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var getParameter = function (parameter) {
      return function (parameters) {
          return Data_Maybe.fromMaybe(0.0)(Data_Map_Internal.lookup(ordParameter)(parameter)(parameters));
      };
  };
  exports["AthenBwhenCworst"] = AthenBwhenCworst;
  exports["AthenCwhenBworst"] = AthenCwhenBworst;
  exports["BthenCwhenAworst"] = BthenCwhenAworst;
  exports["Aworst"] = Aworst;
  exports["Bworst"] = Bworst;
  exports["getParameter"] = getParameter;
  exports["ordParameter"] = ordParameter;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["FirstRound.Logic"] = $PS["FirstRound.Logic"] || {};
  var exports = $PS["FirstRound.Logic"];
  var Choice = $PS["Choice"];
  var Data_Tuple = $PS["Data.Tuple"];
  var Parameter = $PS["Parameter"];                
  var first_choice = function (parameters) {
      return function (choice) {
          var a_worst = Parameter.getParameter(Parameter.Aworst.value)(parameters);
          var b_worst = (1.0 - a_worst) * Parameter.getParameter(Parameter.Bworst.value)(parameters);
          var c_worst = (1.0 - a_worst) * (1.0 - Parameter.getParameter(Parameter.Bworst.value)(parameters));
          if (choice instanceof Choice.AltA) {
              return b_worst * Parameter.getParameter(Parameter.AthenCwhenBworst.value)(parameters) + c_worst * Parameter.getParameter(Parameter.AthenBwhenCworst.value)(parameters);
          };
          if (choice instanceof Choice.AltB) {
              return a_worst * Parameter.getParameter(Parameter.BthenCwhenAworst.value)(parameters) + c_worst * (1.0 - Parameter.getParameter(Parameter.AthenBwhenCworst.value)(parameters));
          };
          if (choice instanceof Choice.AltC) {
              return a_worst * (1.0 - Parameter.getParameter(Parameter.BthenCwhenAworst.value)(parameters)) + b_worst * (1.0 - Parameter.getParameter(Parameter.AthenCwhenBworst.value)(parameters));
          };
          throw new Error("Failed pattern match at FirstRound.Logic (line 26, column 34 - line 29, column 130): " + [ choice.constructor.name ]);
      };
  };
  var first_2_choices = function (parameters) {
      return function (choice1) {
          return function (choice2) {
              var a_worst = Parameter.getParameter(Parameter.Aworst.value)(parameters);
              var b_worst = (1.0 - a_worst) * Parameter.getParameter(Parameter.Bworst.value)(parameters);
              var c_worst = (1.0 - a_worst) * (1.0 - Parameter.getParameter(Parameter.Bworst.value)(parameters));
              var v = new Data_Tuple.Tuple(choice1, choice2);
              if (v.value0 instanceof Choice.AltA && v.value1 instanceof Choice.AltB) {
                  return c_worst * Parameter.getParameter(Parameter.AthenBwhenCworst.value)(parameters);
              };
              if (v.value0 instanceof Choice.AltB && v.value1 instanceof Choice.AltA) {
                  return c_worst * (1.0 - Parameter.getParameter(Parameter.AthenBwhenCworst.value)(parameters));
              };
              if (v.value0 instanceof Choice.AltA && v.value1 instanceof Choice.AltC) {
                  return b_worst * Parameter.getParameter(Parameter.AthenCwhenBworst.value)(parameters);
              };
              if (v.value0 instanceof Choice.AltC && v.value1 instanceof Choice.AltA) {
                  return b_worst * (1.0 - Parameter.getParameter(Parameter.AthenCwhenBworst.value)(parameters));
              };
              if (v.value0 instanceof Choice.AltB && v.value1 instanceof Choice.AltC) {
                  return a_worst * Parameter.getParameter(Parameter.BthenCwhenAworst.value)(parameters);
              };
              if (v.value0 instanceof Choice.AltC && v.value1 instanceof Choice.AltB) {
                  return a_worst * (1.0 - Parameter.getParameter(Parameter.BthenCwhenAworst.value)(parameters));
              };
              return 0.0;
          };
      };
  };
  exports["first_choice"] = first_choice;
  exports["first_2_choices"] = first_2_choices;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["SecondRound.Logic"] = $PS["SecondRound.Logic"] || {};
  var exports = $PS["SecondRound.Logic"];
  var Choice = $PS["Choice"];
  var Data_Array = $PS["Data.Array"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Foldable = $PS["Data.Foldable"];
  ...
  var Data_Ord = $PS["Data.Ord"];
  var Data_Tuple = $PS["Data.Tuple"];
  var FirstRound_Logic = $PS["FirstRound.Logic"];                
  var eliminated_choice = function (parameters) {
      return Data_Maybe.fromMaybe(Choice.AltA.value)(Data_Array.head(Data_Functor.map(Data_Functor.functorArray)(Data_Tuple.fst)(Data_Array.sortBy(Data_Ord.comparing(Data_Ord.ordNumber)(Data_Tuple.snd))(Data_Functor.map(Data_Functor.functorArray)(function (c) {
          return Data_Tuple.Tuple.create(c)(FirstRound_Logic.first_choice(parameters)(c));
      })(Choice.all_choices)))));
  };
  var first_choice = function (parameters) {
      return function (choice) {
          var $0 = Data_Eq.eq(Choice.eqChoice)(choice)(eliminated_choice(parameters));
          if ($0) {
              return Data_Monoid.mempty(Data_Map_Internal.monoidMap(Choice.ordChoice));
          };
          return Data_Map_Internal.fromFoldable(Choice.ordChoice)(Data_Foldable.foldableArray)([ Data_Tuple.Tuple.create(choice)(FirstRound_Logic.first_choice(parameters)(choice)), Data_Tuple.Tuple.create(eliminated_choice(parameters))(FirstRound_Logic.first_2_choices(parameters)(eliminated_choice(parameters))(choice)) ]);
      };
  };
  var score = function (parameters) {
      return function (choice) {
          var $1 = Data_Eq.eq(Choice.eqChoice)(choice)(eliminated_choice(parameters));
          if ($1) {
              return 0.0;
          };
          return FirstRound_Logic.first_choice(parameters)(choice) + FirstRound_Logic.first_2_choices(parameters)(eliminated_choice(parameters))(choice);
      };
  };
  var winner_choice = function (parameters) {
      return Data_Maybe.fromMaybe(Choice.AltA.value)(Data_Array.last(Data_Functor.map(Data_Functor.functorArray)(Data_Tuple.fst)(Data_Array.sortBy(Data_Ord.comparing(Data_Ord.ordNumber)(Data_Tuple.snd))(Data_Functor.map(Data_Functor.functorArray)(function (c) {
          return Data_Tuple.Tuple.create(c)(score(parameters)(c));
      })(Choice.all_choices)))));
  };
  exports["eliminated_choice"] = eliminated_choice;
  exports["winner_choice"] = winner_choice;
})(PS);
(function(exports) {
  "use strict";

  exports.embed_ = element => vega_spec => () => {
    return vegaEmbed(element, vega_spec, { "renderer": "svg", "tooltip": { "theme": "dark" } }).then(result => { return result.view; });
  };
  ...
  exports.round1_spec = {
    ...
    "encoding": {
      ...
      "color": {
        ...
        "scale": {
          "domain": ["A", "B", "C"],
          "range": ["#ff7777", "#77ff77", "#7777ff"]
        }
      }
    }
  };

  exports.update_view = view => data_name => data_values => () => {
    var changeset = vega.
       changeset()
      .insert(data_values)
      .remove(function (t) {
    ...
    return view.change(data_name, changeset).run();
  };
...
})(PS["VegaLite"] = PS["VegaLite"] || {});
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["VegaLite"] = $PS["VegaLite"] || {};
  var exports = $PS["VegaLite"];
  var $foreign = $PS["VegaLite"];
  var Control_Promise = $PS["Control.Promise"];                
  var embed = function (selector) {
      return function (spec) {
          return Control_Promise.toAffE($foreign.embed_(selector)(spec));
      };
  };
  exports["embed"] = embed;
  exports["round1_spec"] = $foreign.round1_spec;
  exports["round2_spec"] = $foreign.round2_spec;
  exports["update_view"] = $foreign.update_view;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  ...
  var Parameter = $PS["Parameter"];
  var SecondRound_Logic = $PS["SecondRound.Logic"];
  var VegaLite = $PS["VegaLite"];                
  var UpdateParameter = (function () {
      function UpdateParameter(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdateParameter.create = function (value0) {
          return function (value1) {
              return new UpdateParameter(value0, value1);
          };
      };
  ...
  var y_max = 100.0;
  var percent_slider = function (description) {
      return function (value) {
          return function (left) {
              return function (right) {
                  return function (onChange) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("slider") ])([ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("description") ])([ Halogen_HTML_Core.text(description) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("label_left") ])([ Halogen_HTML_Core.text(left), Halogen_HTML_Core.text(" ["), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("value") ])([ Halogen_HTML_Core.text(Data_Number_Format.toStringWith(Data_Number_Format.fixed(1))((1.0 - value) * 100.0)) ]), Halogen_HTML_Core.text("%]") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.min(0.0), Halogen_HTML_Properties.max(1.0), Halogen_HTML_Properties.step(new DOM_HTML_Indexed_StepValue.Step(5.0e-3)), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showNumber)(value)), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputRange.value), Halogen_HTML_Events.onValueInput(function (newValue) {
                          return Data_Functor.map(Data_Maybe.functorMaybe)(onChange)(Data_Number.fromString(newValue));
                      }) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("label_right") ])([ Halogen_HTML_Core.text("["), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("value") ])([ Halogen_HTML_Core.text(Data_Number_Format.toStringWith(Data_Number_Format.fixed(1))(value * 100.0)) ]), Halogen_HTML_Core.text("%] "), Halogen_HTML_Core.text(right) ]) ]);
                  };
              };
          };
      };
  };
  var slider1 = function (state) {
      return percent_slider("")(Parameter.getParameter(Parameter.Aworst.value)(state.parameters))("* > (B or C)")("* > A")(UpdateParameter.create(Parameter.Aworst.value));
  };
  var slider2 = function (state) {
      return percent_slider("Assuming A is not worst")(Parameter.getParameter(Parameter.Bworst.value)(state.parameters))("* > C")("* > B")(UpdateParameter.create(Parameter.Bworst.value));
  };
  var slider3 = function (state) {
      return percent_slider("Assuming C is worst")(Parameter.getParameter(Parameter.AthenBwhenCworst.value)(state.parameters))("B > A > C")("A > B > C")(UpdateParameter.create(Parameter.AthenBwhenCworst.value));
  };
  var slider4 = function (state) {
      return percent_slider("Assuming B is worst")(Parameter.getParameter(Parameter.AthenCwhenBworst.value)(state.parameters))("C > A > B")("A > C > B")(UpdateParameter.create(Parameter.AthenCwhenBworst.value));
  };
  var render = function (dictMonadAff) {
      return function (state) {
          return Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("controls") ])([ slider4(state) ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.id_("summary") ])([ Halogen_HTML_Core.text("Round 1 loser: "), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("candidate") ])([ Halogen_HTML_Core.text(Data_Show.show(Choice.showChoice)(SecondRound_Logic.eliminated_choice(state.parameters))) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Core.text("Round 2 winner: "), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("candidate") ])([ Halogen_HTML_Core.text(Data_Show.show(Choice.showChoice)(SecondRound_Logic.winner_choice(state.parameters))) ]) ]) ]);
      };
  };
  var slider5 = function (state) {
      return percent_slider("Assuming A is worst")(Parameter.getParameter(Parameter.BthenCwhenAworst.value)(state.parameters))("C > B > A")("B > C > A")(UpdateParameter.create(Parameter.BthenCwhenAworst.value));
  };
  var make_round2_input = function (state) {
      var eliminated_choice = SecondRound_Logic.eliminated_choice(state);
      var f = function (v) {
          if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Cons) {
              var $11 = Data_Eq.eq(Choice.eqChoice)(v.value0)(eliminated_choice);
              if ($11) {
                  return new Data_Maybe.Just({
                      candidate: Data_Show.show(Choice.showChoice)(v.value1.value0),
                      first_choice: Data_Show.show(Choice.showChoice)(v.value0),
                      amount: y_max * FirstRound_Logic.first_2_choices(state)(v.value0)(v.value1.value0)
                  });
              };
              return new Data_Maybe.Just({
                  candidate: Data_Show.show(Choice.showChoice)(v.value0),
                  first_choice: Data_Show.show(Choice.showChoice)(v.value0),
                  amount: y_max * FirstRound_Logic.first_2_choices(state)(v.value0)(v.value1.value0)
              });
          };
      ...
      return Data_Array.catMaybes(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray)(Data_Functor.map(Data_List_Types.functorList)(f)(Enum.all_permutations(Choice.boundedEnumChoice))));
  };
  var update_round2_data = function (state) {
      return VegaLite.update_view(state.round2_view)("round2-data")(Data_Argonaut_Core.fromArray(Data_Functor.map(Data_Functor.functorArray)(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "first_choice";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "candidate";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "amount";
      }))())()))(make_round2_input(state.parameters))));
  };
  var make_round1_input = function (state) {
      var f = function (v) {
          if (v instanceof Data_List_Types.Cons && v.value1 instanceof Data_List_Types.Cons) {
              return new Data_Maybe.Just({
                  first_choice: Data_Show.show(Choice.showChoice)(v.value0),
                  second_choice: Data_Show.show(Choice.showChoice)(v.value1.value0),
                  amount: y_max * FirstRound_Logic.first_2_choices(state)(v.value0)(v.value1.value0)
              });
          };
          return Data_Maybe.Nothing.value;
  ...
  var update_round1_data = function (state) {
      return VegaLite.update_view(state.round1_view)("round1-data")(Data_Argonaut_Core.fromArray(Data_Functor.map(Data_Functor.functorArray)(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "second_choice";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "first_choice";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "amount";
      }))())()))(make_round1_input(state.parameters))));
  };
  var initial_parameters = Data_Map_Internal.fromFoldable(Parameter.ordParameter)(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple(Parameter.AthenBwhenCworst.value, 0.58), new Data_Tuple.Tuple(Parameter.AthenCwhenBworst.value, 0.0), new Data_Tuple.Tuple(Parameter.BthenCwhenAworst.value, 0.23), new Data_Tuple.Tuple(Parameter.Aworst.value, 0.34), new Data_Tuple.Tuple(Parameter.Bworst.value, 0.16) ]);
  var initial_state = function (round1_view) {
      return function (round2_view) {
          return {
              parameters: initial_parameters,
              round1_view: round1_view,
              round2_view: round2_view
          };
      };
  };
  var handle_action = function (dictMonadEffect) {
      return function (v) {
          if (v instanceof UpdateParameter) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $22.parameters = Data_Map_Internal.insert(Parameter.ordParameter)(v.value0)(v.value1)(state.parameters);
                  return $22;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(function __do() {
                          update_round1_data(state)();
                          return update_round2_data(state)();
                      });
                  });
              });
          };
          if (v instanceof Reset) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $27.parameters = initial_parameters;
                  return $27;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(function __do() {
          ...
          throw new Error("Failed pattern match at Main (line 113, column 1 - line 113, column 111): " + [ v.constructor.name ]);
      };
  };
  var make_component = function (dictMonadAff) {
      return function (round1_view) {
          return function (round2_view) {
              return Halogen_Component.mkComponent({
                  initialState: function (v) {
                      return initial_state(round1_view)(round2_view);
                  },
                  render: render(dictMonadAff),
                  "eval": Halogen_Component.mkEval({
                      handleAction: handle_action(dictMonadAff.MonadEffect0()),
                      handleQuery: Halogen_Component.defaultEval.handleQuery,
                      receive: Halogen_Component.defaultEval.receive,
                      initialize: new Data_Maybe.Just(Reset.value),
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("div#generated-root"))(function (root) {
          return Control_Bind.bind(Effect_Aff.bindAff)(VegaLite.embed("#round1-chart")(VegaLite.round1_spec))(function (round1_view) {
              return Control_Bind.bind(Effect_Aff.bindAff)(VegaLite.embed("#round2-chart")(VegaLite.round2_spec))(function (round2_view) {
                  return Data_Maybe.maybe(Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error("Could not find div#generated-root")))(Halogen_VDom_Driver.runUI(make_component(Effect_Aff_Class.monadAffAff)(round1_view)(round2_view))(Data_Unit.unit))(root);
              });
          });
      });
  }));
  ...
  exports["initial_parameters"] = initial_parameters;
  exports["handle_action"] = handle_action;
  exports["percent_slider"] = percent_slider;
  exports["slider1"] = slider1;
  exports["slider2"] = slider2;
  exports["slider3"] = slider3;
  exports["slider4"] = slider4;
  exports["slider5"] = slider5;
  exports["y_max"] = y_max;
  exports["make_round1_input"] = make_round1_input;
  exports["update_round1_data"] = update_round1_data;
  exports["make_round2_input"] = make_round2_input;
  exports["update_round2_data"] = update_round2_data;
})(PS);
PS["Main"].main();